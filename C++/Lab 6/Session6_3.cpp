// Session6_3.cpp : Defines the entry point for the console application.
//using struct
// reading from file
//writing to file
...
int main()
{
	...
	// note use here of iomanip functions to set the width of EACH field (eg 10 chars) and filling the spare with ' ' ie space
